        ...
        <div className={"salmon-bg"}><div className={"container py-5"}>
            <div className={"row d-flex align-items-center justify-content-center"}>
                ...
                <div className={"col-12 col-lg-6 py-2"}>
                    ...
                    <p><span className={"lead fw-bold"}>FRESH PRODUCE</span><br/>Quality matters. We proudly support local farmers, producers and suppliers by always choosing Australian first for our fresh ingredients.</p>
