...
export default function ArtOfSushi() {
    return(
        <div className="container py-5">
            <p>Back in 1998 we opened our first store opened in Box Hill, Victoria with aspirations to change how Australians eat sushi. Our dream was to take it from high-end Japanese restaurants and make it a fresh, healthy on the go meal available for everyone to enjoy.</p>
