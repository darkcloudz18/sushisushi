...
export default function MenuSection({products, categoryList}) {
            ...
            {categoryList.map((name:string) => {
              return(
                  <div id={name} key={`${name}-products`}>
                    ...
                    {name === "Platters" && <a href={"/Sushi-Sushi-Platters-June-2022.pdf"} target={"_blank"} className={"btn btn-sushi-secondary mb-5"} style={{marginTop: '-1rem'}}>Download our platter brochure</a> }
